...
from models.heads.cls_head import ResnetHead
...
class LitResnet(LightningModule):
    ...
    def __init__(self, cfgs):
        ...
        # ========== backbone
        block = self.cfg_backbone['block']
        num_block = self.cfg_backbone['num_block']
        # ========== network
        self.backbone = ResNet(block, num_block)
        self.head = ResnetHead(512, num_classes=self.num_classes)
        # ========== train
